...
Ideal Effort Force = Multiply the load force by the load distance, then divide by the effort distance --> (F<sub>resistance</sub>&middot;D<sub>resistance</sub>)/D<sub>effort</sub>
...
Ideal Effort Force = Multiply the load force by the load distance, then divide by the effort distance --> (F<sub>load</sub>&middot;D<sub>load</sub>)/D<sub>effort</sub>
...
Ideal Effort Force = Multiply the load force by the load distance, then divide by effort distance --> (F<sub>resistance</sub>&middot;D<sub>resistance</sub>)/D<sub>effort</sub>
